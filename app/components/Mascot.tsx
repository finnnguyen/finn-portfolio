...
// Adapted from https://github.com/nilbuild/page-mascot (MIT License,
// Kamran Ahmed) — a character that watches the cursor and blinks when
// poked. Copied directly rather than installed as a dependency, per the
// project's own "drop into any project" design.
